...
class TextExplainer {
    ...
    showLoadingDialog(text) {
      ...
      <div class="ai-explainer-dialog-header">
        ...
        <button class="ai-explainer-close-btn" onclick="this.closest('.ai-explainer-dialog').remove()">×</button>
      </div>
    ...
    showExplanationDialog(text, explanation) {
      ...
      <div class="ai-explainer-dialog-content">
        ...
        <div class="ai-explainer-actions">
          <button class="ai-explainer-btn ai-explainer-btn-secondary" onclick="navigator.clipboard.writeText(decodeURIComponent('${encodeURIComponent(explanation)}'))">Copy</button>
          <button class="ai-explainer-btn ai-explainer-btn-primary" onclick="window.open('chrome-extension://${chrome.runtime.id}/src/settings/settings.html')">Settings</button>
        </div>
      </div>
    `;
    ...
    showErrorDialog(error) {
      ...
      <div class="ai-explainer-dialog-content">
        ...
        <div class="ai-explainer-actions">
          <button class="ai-explainer-btn ai-explainer-btn-primary" onclick="window.open('chrome-extension://${chrome.runtime.id}/src/settings/settings.html')">Open Settings</button>
        </div>
      </div>
    `;
