...
class PopupManager {
    ...
    showPrivacyInfo() {
        const modal = this.createModal('Privacy Information', `
      <p><strong>AI Text Explainer Privacy Policy</strong></p>
      <ul>
        <li>Your API keys are stored locally in your browser only</li>
        <li>Selected text is sent to your chosen AI provider for explanation</li>
        <li>We do not store or log your text selections</li>
        <li>No personal data is collected by this extension</li>
        <li>You can delete all data by removing the extension</li>
      </ul>
      <p><small>Last updated: ${new Date().toDateString()}</small></p>
    `);
        document.body.appendChild(modal);
    }

    showHelp() {
        const modal = this.createModal('Help & FAQ', `
      <p><strong>How to get started:</strong></p>
      <ol>
        <li>Click "Settings" to configure an AI provider</li>
        <li>Add your API key for OpenAI, Anthropic, or Google Gemini</li>
        <li>Select any text on a webpage</li>
        <li>Click the "🤖 Explain" button that appears</li>
      </ol>
      
      <p><strong>Troubleshooting:</strong></p>
      <ul>
        <li>If explanations don't work, check your API key in settings</li>
        <li>Make sure you have sufficient API credits</li>
        <li>Try switching to a different AI model</li>
        <li>Check your internet connection</li>
      </ul>
      
      <p><strong>Need more help?</strong> Contact support through the feedback option.</p>
    `);
        document.body.appendChild(modal);
    }
    ...
    showFeedback() {
      ...
      <p>We'd love to hear from you! Help us improve AI Text Explainer:</p>
      
      <div style="margin: 16px 0;">
        <p><strong>Ways to provide feedback:</strong></p>
        <ul>
          <li>Report bugs or request features</li>
          <li>Share your experience</li>
          <li>Suggest new AI providers</li>
          <li>Recommend improvements</li>
        </ul>
      </div>
      
      <p><strong>Contact:</strong></p>
      <p>📧 Email: support@aitextexplainer.com</p>
      <p>🐛 GitHub: github.com/aitextexplainer</p>
      
      <p><small>Thank you for using AI Text Explainer!</small></p>
    `);
        document.body.appendChild(modal);
    }
